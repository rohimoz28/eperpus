...
<div class="container">
  ...
  <div class="d-sm-flex align-items-center justify-content-between col-md-12 my-3">
    ...
    <form action="<?= base_url('restore/generatePdf') ?>" method="POST">
      <button type="submit" class="d-none d-sm-inline-block btn btn-sm btn-info shadow-sm"><i class="fas fa-download fa-sm text-white-50"></i> Data Pengembalian Buku</button>
    </form>
  </div>
  <div class="row">
